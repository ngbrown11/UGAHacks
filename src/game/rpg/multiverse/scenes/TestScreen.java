...
public class TestScreen extends Scene {
	...
	public TestScreen(Parent root, double width, double height) {
	...
	public void initialize(Group root) {
		...
		move1.setLayoutX(300);		//Set location
		move1.setLayoutY(225);
		Button move2 = new Button("B");
		move2.setLayoutX(325);		//Set location
		move2.setLayoutY(200);
		Button move3 = new Button("X");
		move3.setLayoutX(315);		//Set location
		move3.setLayoutY(235);
		Button move4 = new Button("Y");
		move4.setLayoutX(340);		//Set location
		move4.setLayoutY(230);
